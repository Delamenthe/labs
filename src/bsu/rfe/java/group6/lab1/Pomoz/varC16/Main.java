...
public class Main
{
    ...
    public static void main(String[] args) throws Exception {
        ...
        Food Apple1 = new Apple("маленькое");
        Food Apple2 = new Apple("среднее");
        Food Apple3 = new Apple("большое");
        Food Sandwich1 = new Sandwich("Колбаса","Сыр");
        Food Sandwich2 = new Sandwich("Помидор","Сыр");
        Food Sandwich3 = new Sandwich("Авокадо","Яйцо");
        Food Sandwich4 = new Sandwich("Шпроты","Морковь");
        Food Sandwich5 = new Sandwich("Семга","Масло");
        Food Sandwich6 = new Sandwich("Творог","Зелень");
            for (Food item : breakfast){
                if (flag3) {
                    if (item != null) {
                        if (item.equals(Apple1) || item.equals(Apple2) ||item.equals(Apple3))
                            apple++;
                    }
                }
                if (flag4) {
